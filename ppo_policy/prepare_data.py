...
def tuple_events_to_midi(events, save_path, tick_resolution=utils.DEFAULT_RESOLUTION):
    ...
    for e in events:
        ...
        st = int(bar_cnt  * ticks_per_bar + (Fraction(e.Position) * ticks_per_bar))
...
if __name__ == '__main__':
    ...
    # training setup
    parser.add_argument('--midi-folder', type=str, default='/sppvenv/music_data/dataset_Pop1K7/midi_synchronized', help="Folder containing the midi files.")
